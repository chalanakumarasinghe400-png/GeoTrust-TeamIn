        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              color: role != null
                  ? (Theme.of(context).brightness == Brightness.dark ? role.color.shade800 : role.color)
                  : (Theme.of(context).brightness == Brightness.dark ? Colors.teal.shade800 : Colors.teal),
            ),
            child: Column(
  ...
  Widget _buildHistoryList(
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        final locationName = ledger.locationIdToName[permit.originLocationId] ?? 'Unknown Location';
                  ...
                  : () async {
                      ...
                      try {
                        final response = await Supabase.instance.client
                            ...
                            .maybeSingle();
                        if (response == null || response['password'] != _currentPasswordCtrl.text) {
                          if (mounted) {
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(
